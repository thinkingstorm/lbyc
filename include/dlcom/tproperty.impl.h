...
#ifndef __PROPERTY_TEMPLATE_IMP_H__
#define __PROPERTY_TEMPLATE_IMP_H__
...
struct prop_variant<LPSTR>
{
	...
	static HRESULT construct_with(void *pThis, const void *pRhs)
	{
		...
		retrtpv(__rhs->pszVal, (__this->pszVal = 0, S_OK));
		size_t cch = strlen(__rhs->pszVal) +1;
		retrtpv(__this->pszVal = new CHAR[cch], E_OUTOFMEMORY);
...
struct prop_variant<LPWSTR>
{
	...
	static HRESULT construct_with(void *pThis, const void *pRhs)
	{
		...
		retrtpv(__rhs->pwszVal, (__this->pwszVal = 0, S_OK));
		size_t cch = wcslen(__rhs->pwszVal) +1;
		retrtpv(__this->pwszVal = new WCHAR[cch], E_OUTOFMEMORY);
...
template<>
struct prop_variant<IModuleBase*>
{
	IModuleBase *punkVal;
	static HRESULT construct_with(void *pThis, const void *pRhs)
	{
		if(((((prop_variant<IModuleBase*>*)pThis)->punkVal = ((const prop_variant<IModuleBase*>*)pRhs)->punkVal)) != NULL)
		{
			((prop_variant<IModuleBase*>*)pThis)->punkVal->AddRef();
		}
		return S_OK;
	}
	static HRESULT destroy(void *pThis)
	{
		if(((prop_variant<IModuleBase*>*)pThis)->punkVal)
		{
			((prop_variant<IModuleBase*>*)pThis)->punkVal->Release();
			((prop_variant<IModuleBase*>*)pThis)->punkVal = 0;
		}
		return S_OK;
	}
};
...
struct prop_variant<CLSID*>
{
	...
	static HRESULT construct_with(void *pThis, const void *pRhs)
	{
		...
		retrtpv(__this->puuid = new CLSID, E_OUTOFMEMORY);
...
PROP_DEF_NONTRIVIAL_TYPE_TRAITS(IModuleBase*);
...
struct prop_variant_vector
{
	...
	static HRESULT construct_with(void *pThis, const void *pRhs)
	{
		...
		__this->cElems = 0;
		retrtpv(__rhs->cElems, (__this->pElems = 0, S_OK));
		retrtp((__this->pElems = new T [__rhs->cElems]), E_UNEXPECTED);
...
struct prop_variant_safearray : SAFEARRAY
{
	static HRESULT construct_with(void *pThis, const void *pRhs)
	{
		...
		retrtpv(sizeof(T) == __this->cbElements, E_INVALIDARG);
		__this->pvData = 0;
		retrtpv(__this->cDims, S_OK);
		...
		retrtpv(__rhs_vec.cElems, (__this->cDims = 0, S_OK));
